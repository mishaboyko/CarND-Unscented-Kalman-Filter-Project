...
void RadarProcessor::Init(int n_x_in, int n_aug_in, VectorXd weights_in) {
    n_x_ = n_x_in;
...
void RadarProcessor::PredictMeasurement(MatrixXd& Xsig_pred_){
...
void RadarProcessor::Update(VectorXd& measurement, objectState* object_state, MatrixXd& Xsig_pred_) {
